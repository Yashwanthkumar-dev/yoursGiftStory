...
const WhyChooseUs = () => {
    ...
    return (
        <>
            ...
            <div className='pb-12'>
                <div>
                    <h2 className='text-center mt-8 font-playfair text-[#2A5D5D] font-semibold text-[25px] capitalize w-[12rem] tracking-wide mx-auto'>Why choose YoursGiftStory</h2>
                </div>
                <div className='p-4 space-y-12'>
                    {
                        whyusUs.map((card, index) => (
                            <div key={index} className='text-center p-4 rounded-lg bg-white font-playfair shadow-md shadow-gray-300 mt-5 space-y-3 hover:shadow-lg transition duration-500'>
